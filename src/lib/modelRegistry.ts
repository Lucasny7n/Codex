...
export const localModelRegistry: LocalModelProfile[] = [
  ...
  localModel({
    ...
    vram: '16-24 GB',
    disk: '14 GB aprox.',
    expectedPerformance: 'Modelo agente/código pesado; use com GPU ou bastante RAM.',
    recommendedHardware: 'gpu',
    strengths: ['Código', 'Fluxos agenticos', 'Raciocínio técnico'],
    weaknesses: ['Pesado', 'Pode ser lento em CPU'],
    bestFor: ['Agentes locais de código', 'Refactors com contexto'],
    tags: ['local', 'pesado', 'codigo', 'raciocinio'],
    capabilities: { speed: 2, reasoning: 4, coding: 5, text: 4, longContext: 4 },
    heavy: true,
  }),
  localModel({
    ...
    vram: '6-8 GB',
    disk: '5 GB aprox.',
    expectedPerformance: 'Bom foco em código com custo local moderado.',
    recommendedHardware: 'either',
    strengths: ['Código', 'Licença aberta', 'Uso corporativo'],
    weaknesses: ['Menos geralista que Llama/Qwen'],
    bestFor: ['Código local', 'Revisões pequenas', 'Scripts'],
    tags: ['local', 'codigo', 'medio'],
    capabilities: { speed: 3, reasoning: 3, coding: 4, text: 3, longContext: 3 },
  }),
  localModel({
    ...
    vram: '16-24 GB',
    disk: '12 GB aprox.',
    expectedPerformance: 'Código mais forte, pesado para máquina modesta.',
    recommendedHardware: 'gpu',
    strengths: ['Código forte', 'Contexto técnico'],
    weaknesses: ['Pesado'],
    bestFor: ['Código local pesado', 'Análise de repositório'],
    tags: ['local', 'codigo', 'pesado'],
    capabilities: { speed: 2, reasoning: 4, coding: 5, text: 3, longContext: 4 },
    heavy: true,
  }),
  localModel({
    ...
    vram: '8-12 GB',
    disk: '6.5 GB aprox.',
    expectedPerformance: 'Geralista conversacional com bom equilíbrio local.',
    recommendedHardware: 'either',
    strengths: ['Chat geral', 'Texto', 'Instruções'],
    weaknesses: ['Não é coder especializado'],
    bestFor: ['Chat local', 'Escrita', 'Resumo'],
    tags: ['local', 'geral', 'medio', 'texto'],
    capabilities: { speed: 3, reasoning: 4, coding: 3, text: 4, longContext: 4 },
  }),
  localModel({
    ...
    vram: '20-32 GB',
    disk: '26 GB aprox.',
    expectedPerformance: 'MoE pesado, útil para chat avançado em hardware forte.',
    recommendedHardware: 'gpu',
    strengths: ['Chat geral', 'Raciocínio', 'Modelo MoE'],
    weaknesses: ['Muito pesado', 'Pode ser lento'],
    bestFor: ['Chat local pesado', 'Experimentação'],
    tags: ['local', 'pesado', 'geral', 'raciocinio'],
    capabilities: { speed: 1, reasoning: 4, coding: 4, text: 5, longContext: 4 },
    heavy: true,
  }),
  localModel({
    ...
    vram: '1-2 GB',
    disk: '0.8 GB aprox.',
    expectedPerformance: 'Muito leve; bom para smoke test local, não para qualidade alta.',
    recommendedHardware: 'cpu',
    strengths: ['Muito leve', 'Rápido', 'Baixo disco'],
    weaknesses: ['Qualidade limitada'],
    bestFor: ['Teste rápido', 'Hardware fraco'],
    tags: ['local', 'leve', 'rapido'],
    capabilities: { speed: 5, reasoning: 1, coding: 2, text: 2, longContext: 1 },
  }),
  localModel({
    ...
    vram: '2 GB',
    disk: '1.2 GB aprox.',
    expectedPerformance: 'Leve para chat curto e automações simples.',
    recommendedHardware: 'cpu',
    strengths: ['Leve', 'Rápido', 'Uso geral simples'],
    weaknesses: ['Limitado para código e raciocínio longo'],
    bestFor: ['Resumo curto', 'Teste local', 'Chat leve'],
    tags: ['local', 'leve', 'rapido', 'geral'],
    capabilities: { speed: 5, reasoning: 2, coding: 2, text: 3, longContext: 2 },
  }),
  localModel({
    id: 'openchat:latest',
    ...
    vram: '6-8 GB',
    disk: '4.2 GB aprox.',
    expectedPerformance: 'Chat geral moderado; alternativa local leve.',
    recommendedHardware: 'either',
    strengths: ['Chat geral', 'Texto'],
    weaknesses: ['Menos forte em código'],
    bestFor: ['Q&A local', 'Chat offline'],
    tags: ['local', 'geral', 'medio'],
    capabilities: { speed: 3, reasoning: 3, coding: 3, text: 4, longContext: 3 },
  }),
  localModel({
    ...
    vram: '6-8 GB',
    disk: '4.2 GB aprox.',
    expectedPerformance: 'Coder mais antigo, ainda útil para snippets e Python.',
    recommendedHardware: 'either',
    strengths: ['Código', 'Python', 'Leve para coder'],
    weaknesses: ['Mais antigo que Qwen/DeepSeek Coder'],
    bestFor: ['Snippets Python', 'Fallback local de código'],
    tags: ['local', 'codigo', 'medio'],
    capabilities: { speed: 3, reasoning: 3, coding: 4, text: 2, longContext: 3 },
  }),
];
