...
If future changes copy third-party code, assets, documentation structure or substantial text, update this file, `docs/credits.md` and any required source comments before merging.
